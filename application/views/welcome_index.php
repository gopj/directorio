    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li><a href="#portfolio">RESTAURANTES</a>
            </li>
            <li><a href="#contact">CONTACTO</a>
            </li>
            <li><a href="#contact">PROMOCIONES</a>              
            </li>
        </ul>
    </div>
    <!-- /Side Menu -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <h2>Somos el mejor directorio de lugares y servicios de Colima</h2>
                    <p class="lead"></a>.</p>
                </div>
            </div>
        </div>
    ...
    <!-- Portfolio -->
    <div id="portfolio" class="portfolio callout">
      <div class="container">
    ...
    <div class="call-to-action">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <h3>Quieres formar parte, no esperes mas</h3>
